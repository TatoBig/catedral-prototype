      ...
      <div className="bg-black h-screen">
        ...
        <div className="absolute h-screen w-full">
          <div className="relative md:mt-40 left-0 right-0 m-auto md:w-4/5 md:h-1/2 h-2/3">
            <Image priority alt="Imagen iglesia catedral" loading="eager" src="/image.jpg" layout="fill" className=" mix-blend-lighten object-[-225px] md:object-center object-cover" />
            <div
